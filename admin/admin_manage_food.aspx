                ...
                %>
                    <div class="show-food-info">
                        <div class="inner-food-info">
                            ...
                            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="food_modify_validation" />
    ...
    <div class="container">
        ...
        <div class="inner-container">
                ...
                <div id="add_food_form_id" class="add_food_form">
                    ...
                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" ForeColor="Red" style="text-align:left" ValidationGroup="add_food_validation"/>
